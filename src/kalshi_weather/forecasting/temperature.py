...
from kalshi_weather.forecasting.calibration import (
    confidence_from_lead_time,
    inflate_ensemble_spread,
)
from kalshi_weather.calibration.station_bias import get_station_bias_for_condition
from kalshi_weather.common.types import celsius_to_fahrenheit, fahrenheit_to_celsius
from kalshi_weather.forecasting.utils import find_closest_time_idx, find_period_time_indices
from kalshi_weather.markets.models import Comparison, MarketParams
from kalshi_weather.weather.models import EnsembleForecast, HRRRForecast, NOAAForecast
from kalshi_weather.weather.stations import station_for_location
...
class TemperatureModel:
    ...
    async def estimate(
        ...
        *,
        ...
        station_id = station.icao if station is not None else None
        ...
        return ProbabilityEstimate(
            probability=float(np.clip(blended_cal, floor, ceiling)),
