...
@dataclass
class MarketParams:
    """Parsed parameters extracted from a market ticker/question.
...
@dataclass
class WeatherMarket:
    """A Kalshi market identified as weather-related.

    Combines raw market data with parsed parameters.
    """

    market_id: str  # Kalshi ticker (e.g., "KXHIGHNY-26MAR07-B55")
    event_ticker: str  # Parent event (e.g., "KXHIGHNY-26MAR07")
    series_ticker: str  # Series (e.g., "KXHIGHNY")
