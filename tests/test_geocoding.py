...
from kalshi_weather.weather.geocoding import geocode, _cache, _STATION_COORDS
...
async def test_geocode_success():
    ...
    with patch("kalshi_weather.weather.geocoding.Nominatim", return_value=mock_geolocator):
